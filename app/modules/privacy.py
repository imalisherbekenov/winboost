...
def get_category(log_success, log_error, log_info):
    return {
        ...
        "actions": [
            {"name": "Отключить телеметрию", "desc": "DiagTrack, сбор данных", "run": lambda: disable_telemetry(log_success, log_error, log_info), "icon": "shield", "risk": "red", "irreversible": False, "effects": TELEMETRY_EFFECTS},
            {"name": "Отключить Cortana", "desc": "Голосовой помощник", "run": lambda: disable_cortana(log_success, log_error, log_info), "icon": "eye-off", "risk": "yellow", "irreversible": False, "effects": CORTANA_EFFECTS},
            {"name": "Отключить Timeline", "desc": "История действий", "run": lambda: disable_timeline(log_success, log_error, log_info), "icon": "eye-off", "risk": "yellow", "irreversible": False, "effects": TIMELINE_EFFECTS},
            {"name": "Отключить Advertising ID", "desc": "Рекламный трекинг", "run": lambda: disable_advertising_id(log_success, log_error, log_info), "icon": "eye-off", "risk": "blue", "irreversible": False, "effects": ADVERTISING_EFFECTS},
            {"name": "Отключить Wi-Fi Sense", "desc": "Авто-подключение", "run": lambda: disable_wifi_sense(log_success, log_error, log_info), "icon": "wifi", "risk": "blue", "irreversible": False, "effects": WIFI_SENSE_EFFECTS},
            {"name": "Отключить геолокацию", "desc": "Отслеживание местоположения", "run": lambda: disable_location_tracking(log_success, log_error, log_info), "icon": "pin", "risk": "yellow", "irreversible": False, "effects": LOCATION_EFFECTS},
            {"name": "Отключить Feedback", "desc": "Запросы обратной связи", "run": lambda: disable_feedback(log_success, log_error, log_info), "icon": "eye-off", "risk": "blue", "irreversible": False, "effects": FEEDBACK_EFFECTS},
            {
                "name": "🔒 Применить ВСЁ",
